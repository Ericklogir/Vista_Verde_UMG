...
public class CasasM extends JPanel {
    ...
    private void cargarMorosos() {
        ...
        try(Connection con =
            ...
            // TODAS LAS CASAS
            // =========================
          String sqlCasas = "SELECT c.numero, p.nombre, p.telefono FROM casa c INNER JOIN propietario p ON c.Dpi = p.Dpi ORDER BY c.numero ASC";
            ...
            lblCasasDia.setText(
                    String.valueOf(
                            totalconpropietario - totalMorosos
                    )
            );
